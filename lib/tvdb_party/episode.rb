module TvdbParty
  class Episode
    attr_reader :client
    attr_accessor :id, :season_number, :number, :name, :overview, :air_date, :thumb, :guest_stars, :director, :writer, :last_updated_time
    ...
    def initialize(client, options={})
      ...
      @series_id = options["seriesid"] ? options["seriesid"] : options["series"]
